...
> PaginatedCampaignsList GetCampaigns(ctx).Cursor(cursor).PageSize(pageSize).Execute()
...
func main() {
	...
	resp, r, err := apiClient.CampaignsAPI.GetCampaigns(context.Background()).Cursor(cursor).PageSize(pageSize).Execute()
	if err != nil {
