...
`func (o *RunOpalQueryRequest) GetQuery() OpalAccessPathQueryBody`

GetQuery returns the Query field if non-nil, zero value otherwise.

### GetQueryOk

`func (o *RunOpalQueryRequest) GetQueryOk() (*OpalAccessPathQueryBody, bool)`
...
`func (o *RunOpalQueryRequest) SetQuery(v OpalAccessPathQueryBody)`
...
`func (o *RunOpalQueryRequest) GetIncludeCount() bool`

GetIncludeCount returns the IncludeCount field if non-nil, zero value otherwise.

### GetIncludeCountOk

`func (o *RunOpalQueryRequest) GetIncludeCountOk() (*bool, bool)`
...
`func (o *RunOpalQueryRequest) SetIncludeCount(v bool)`

SetIncludeCount sets IncludeCount field to given value.

### HasIncludeCount

`func (o *RunOpalQueryRequest) HasIncludeCount() bool`
