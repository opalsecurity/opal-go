...
const (
	...
	PROPAGATIONSTATUSENUM_ERR_REMOTE_TICKET_NOT_FOUND PropagationStatusEnum = "ERR_REMOTE_TICKET_NOT_FOUND"
	PROPAGATIONSTATUSENUM_ERR_CONNECTION_VALIDATION_FAILED PropagationStatusEnum = "ERR_CONNECTION_VALIDATION_FAILED"
)
