...
type _UpdateEventStreamInfo UpdateEventStreamInfo
...
func (o *UpdateEventStreamInfo) UnmarshalJSON(data []byte) (err error) {
	varUpdateEventStreamInfo := _UpdateEventStreamInfo{}

	err = json.Unmarshal(data, &varUpdateEventStreamInfo)

	if err != nil {
		return err
	}

	*o = UpdateEventStreamInfo(varUpdateEventStreamInfo)
