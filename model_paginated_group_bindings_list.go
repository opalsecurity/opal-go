...
// checks if the PaginatedGroupBindingsList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedGroupBindingsList{}

// PaginatedGroupBindingsList struct for PaginatedGroupBindingsList
...
func NewPaginatedGroupBindingsList(results []GroupBinding) *PaginatedGroupBindingsList {
	this := PaginatedGroupBindingsList{}
...
func (o PaginatedGroupBindingsList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedGroupBindingsList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedGroupBindingsList) UnmarshalJSON(data []byte) (err error) {
...
type NullablePaginatedGroupBindingsList struct {
	value *PaginatedGroupBindingsList
	isSet bool
}

func (v NullablePaginatedGroupBindingsList) Get() *PaginatedGroupBindingsList {
	return v.value
}

func (v *NullablePaginatedGroupBindingsList) Set(val *PaginatedGroupBindingsList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedGroupBindingsList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedGroupBindingsList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedGroupBindingsList(val *PaginatedGroupBindingsList) *NullablePaginatedGroupBindingsList {
	return &NullablePaginatedGroupBindingsList{value: val, isSet: true}
}

func (v NullablePaginatedGroupBindingsList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedGroupBindingsList) UnmarshalJSON(src []byte) error {
	v.isSet = true
